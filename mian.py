...
class MTNet:
    def __init__(self):
        ...
        self.net = Network.TransBlock(hs_band=31,pan_band=1,itra_num=self.itration_K).cuda()
    ...
    def Test(self):
        self.net.eval().cpu()
        self.net.load_state_dict(torch.load(self.net_save_path +'the_CAVE_maxpsnr_model.pkl'))
        ...
        if(os.path.exists(self.cutpatch_path)):
